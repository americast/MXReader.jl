#from https://github.com/dmlc/MXNet.jl/blob/master/deps/build.jl with required edits at 100, 101 and 102 (line nos. wrt this file)
...
if !libmxnet_detected
  ...
  _prefix = joinpath(Pkg.dir("MXReader"), "deps/usr")
  _srcdir = joinpath(Pkg.dir("MXReader"), "deps/src")
